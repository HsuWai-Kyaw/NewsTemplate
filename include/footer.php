<div class="col-lg-4 col-md-4 col-sm-4">
     <div class="latest_post">
        ...
        ?>
                    <li>
                         <div class="media"> <a href="read-post.php?id=<?php echo $id; ?>" class="media-left"> <img
                                        alt="" src="./admin/upload/thumbnail/<?php echo $img; ?>"> </a>
                              <div class="media-body"> <a href="read-post.php?id=<?php echo $id; ?>" class="catg_title">
                                        <?php echo $heading; ?> </a> </div>
                         </div>
                    </li>
                    <?php
     ...
     <aside class="right_content">
          ...
          ?>
                         <li>
                              <div class="media"> <a href="read-post.php?id=<?php echo $id; ?>" class="media-left"> <img
                                             alt="" src="./admin/upload/thumbnail/<?php echo $img; ?>"> </a>
                                   <div class="media-body"> <a href="read-post.php?id=<?php echo $id; ?>"
                                             class="catg_title"> <?php echo $heading; ?> </a> </div>
                              </div>
                         </li>
                         <?php
            }
          ...
          <div class="single_sidebar">
              ...
              ?>
                                   <li class="cat-item"><a
                                             href="read-category.php?category=<?php echo $c_name; ?> "><?php echo ucwords($c_name); ?>
                                             (<?php echo $post; ?>)</a></li>
                                   <?php
                }
              }
...
<footer id="footer">
     <div class="footer_top">
          <div class="row">
            ...
            ?>
                              <li><a href="read-category.php?category=<?php echo $c_name; ?> ">
                                        <?php echo ucwords($c_name); ?> </a></li>
                              <?php
              }
            }
            ?>
          ...
          ?>
                         ...
                         <address>
                              ...
                              <P> Phone: <a style="color:rgb(218,218,218);" href="tel:<?php echo $phn ?>">
                                        <?php echo $phn; ?> </a></P>
                              <p>Email : <a style="color:rgb(218,218,218);" href="mailto:<?php echo $email; ?>">
                                        <?php echo $email; ?> </a> </p>
     ...
     <div class="footer_bottom">
          <p class="copyright">Copyright &copy; <?php echo date("Y", strtotime("now")); ?> <a
                    href="./index.php">Goodvibe</a></p>
          <p class="developer" style="color:white;">Developed By goodvibe</p>
          <!-- Wpfreeware -->
     </div>
</footer>
</div>
