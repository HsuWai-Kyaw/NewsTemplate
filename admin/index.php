          ...
          <div class="col-lg-4 col-md-4 col-sm-12">
               <div class="card shadow ">
                    <ul class="list-group list-group-flush">
                         ...
                         <li class="list-group-item">Total Category: <span class="text-center">
                                   <?php echo mysqli_num_rows($result); ?> </span> </li>
                         <li class="list-group-item text-center"><a href="manage-category.php"><b>View All
                                        Categories</b></a></li>
                    </ul>
               </div>
          </div>
               ...
               <div class="card shadow ">
                    <ul class="list-group list-group-flush">
                         ...
                         <li class="list-group-item text-left">Total Posts : <?php
                                                                                ...
                                                                                ?></li>
                         <li class="list-group-item text-center"><a href="manage-post-desc.php"><b>View All
                                        Posts</b></a> </li>
                    </ul>
               </div>
          </div>
          ...
          <div class="col-lg-6 col-md-6 col-sm-12 ">
               <div class="card shadow ">
                    <ul class="list-group list-group-flush">
                         ...
                         <li class="list-group-item text-center"> <a href="contact-us.php"><b>Edit Contact Details</b>
                              </a></li>
                    </ul>
               </div>
          </div>
               ...
               <div class="card shadow">
                    <ul class="list-group list-group-flush">
                         ...
                         <li class="list-group-item">
                              ...
                              <iframe src="https://www.google.com/maps?q=<?php echo $address; ?>&output=embed"
                                   style=" height:230px; width:100%;" allowfullscreen="" loading="lazy"></iframe>
                         </li>
                    </ul>
               </div>
          </div>
          ...
          <div class="col-lg-3 col-md-9 col-sm-12 ">
               <div class="">
                    <ul class="list-group list-group-flush pt-5 ">
                         ...
                         <li class="list-group-item text-center"> <a class="btn btn-outline-primary"
                                   href="about-us.php"><b>Edit About Us </b> </a> </li>
