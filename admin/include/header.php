...
<head>
     ...
     <title>GoodVibe- Admin Pannel</title>
                    ...
                    <ul class="metismenu" id="menu">
                         ...
                         <li>
                              ...
                              <ul aria-expanded="false">
                                   <li><a href="./add-category.php"> <i class="icon-plus menu-icon"></i>Add Category</a>
                                   </li>
                                   <li><a href="./manage-category.php"><i class="fa fa-cog menu-icon"></i>Manage
                                             Category</a></li>
                              </ul>
                         </li>
                         <li>
                              <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                                   <i class="fa fa-pencil-square-o menu-icon"></i><span class="nav-text">Post
                                        Description</span>
                              </a>
                              <ul aria-expanded="false">
                                   <li><a href="./add-post-desc.php"> <i class="icon-plus menu-icon"></i>Add Post
                                             Description</a></li>
                                   <li><a href="./manage-post-desc.php"><i class="fa fa-cog menu-icon"></i>Manage Post
                                             Description</a></li>
                              </ul>
                         </li>
                         ...
                         <li>
                              ...
                              <ul aria-expanded="false">
                                   <li><a href="./add-post-details.php"><i class="icon-plus menu-icon"></i>Add Post</a>
                                   </li>
                                   <li><a href="./manage-post-details.php"><i class="fa fa-cog menu-icon"></i>Manage
                                             Post</a></li>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                         <div class="modal-content">
                              ...
                              <div class="modal-footer ">
                                   <div class="mx-auto">
                                        <a type="button" id="linkBtn" href="#" class="btn btn-primary">Add Expense For
                                             the Day</a>
